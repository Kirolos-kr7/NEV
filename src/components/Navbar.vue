<template>
  <nav
    class="container fixed !bg-opacity-90 backdrop-blur-md h-[60px] sm:h-[70px] bg-white dark:bg-dark2 flex justify-between items-center flex-row min-w-full px-3 sm:px-12 z-40 shadow-sm"
  >
