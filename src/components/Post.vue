  ...
  >
    ...
    <div class="block p-5 w-full">
      <div class="flex items-center mb-2" v-if="!thumbnail">
        ...
        ></div>
        <div class="flex flex-col ml-3 sm:ml-0 sm:block">
          <h4 class="font-semibold dark:text-white font-BioRhyme sm:hidden">
            {{ post?.byFullName }}
          </h4>
          <div class="dark:text-gray-400 pt-0.5 sm:pt-0 text-sm font-BioRhyme">
      ...
      <div :class="!thumbnail ? 'ml-10' : ''">
        <div class="flex items-start justify-between">
          ...
          >
            ...
            <div
              class="mnu absolute top-[35px] right-0 border-solid rounded-md border-4 dark:border-black w-48 transition hidden"
              :id="post.id"
        ...
        >
          <svg
            ...
            class="w-6 h-6 transition-all dark:text-black -m-0.5"
            :id="'l' + post.id"
            fill="#9ca3af3d"
            stroke="currentColor"
            viewBox="0 0 24 24"
