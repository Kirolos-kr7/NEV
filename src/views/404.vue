<template>
  <div
    class="wrapper w-full sm:w-9/12 mx-auto px-4 h-screen flex flex-col items-center justify-center dark:bg-dark1"
  >
    ...
    <router-link to="/" class="btn-medium no-underline blueish mt-5">
      Back To Home Page
    </router-link>
  </div>
</template>
